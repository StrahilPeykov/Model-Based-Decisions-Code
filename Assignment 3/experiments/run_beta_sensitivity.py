...
def main():
    ...
    parser.add_argument("--ratio", type=float, default=2.0, help="Initial payoff ratio a_I/b.")
    parser.add_argument("--beta-list", type=float, nargs="+", default=[0.5, 1.0, 1.5, 2.0, 2.5, 3.0], help="beta_I values.")
    ...
    parser.add_argument("--i0", type=float, default=0.05, help="Initial infrastructure.")
    parser.add_argument("--x0", type=float, default=0.10, help="Initial EV share.")
